...
public class BlurActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    mGoButton.setOnClickListener(view -> mViewModel.applyBlurUnique(getBlurLevel()));
    ...
    mViewModel.getOutputWorkInfo().observe(this, listOfWorkInfos -> {
      ...
      if (!finished) {
        ...
        if (!TextUtils.isEmpty(outputImageUri)) {
          mViewModel.setOutputUri(outputImageUri); // TODO set the output Uri in the ViewModel
          mOutputButton.setVisibility(View.VISIBLE);// TODO show mOutputButton
        }
      }
    });
